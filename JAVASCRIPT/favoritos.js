////// API KEY: 
apiKey = "apqm2sZx8lShM1fBlnFdqKEb30l05tAE";
...
//mostrar los favoritos en la pagina
function buscarFavoritos() {
    ...
    if (favoritosString == null || favoritosString == "[]") {
        //si no hayfavoritos, mostrar pantalla favoritos vacia
